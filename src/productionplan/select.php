...
//	header("Access-Control-Allow-Origin: *");
	...
	if ($flag == "Select") {
		...
		if ($isfinish == '0') {
			...
			// 过滤重复作为下拉checkbox数据
			$sql2 = "SELECT DISTINCT product_name from productionplan WHERE isfinish='0' and isexterior='0' and Pisfinish='0' and route in $list  ORDER BY id DESC,routeid";
			...
			$sql3 = "SELECT DISTINCT pNumber from productionplan WHERE isfinish='0' and isexterior='0' and Pisfinish='0' and route in $list  ORDER BY id DESC,routeid";
		...
		// 已就工数据列表
	  $sql4 = "select a.modid,a.fid,a.id,a.figure_number,a.name,a.standard,a.route,a.count,a.child_material,a.number,a.product_name,a.remark,b.stime,a.routeid,a.backMark,a.reason,a.pNumber from productionplan a,workshop_k b WHERE a.isfinish='2' and a.modid=b.modid and a.route=b.route and a.route in ".$list." ORDER BY a.id DESC";
...
//	      $arr4[$i]['schedule_date'] = $row4['schedule_date'];
	    ...
	    // 下拉项目名称
	    $sql5 = "SELECT DISTINCT a.product_name FROM productionplan a,workshop_k b WHERE a.isfinish='2' and a.route=b.route and a.modid=b.modid and a.route in ".$list." ORDER BY a.id DESC";
	    ...
	    // 下拉筛选工单
	    $sql6 = "SELECT DISTINCT A.pNumber FROM productionplan a,workshop_k b WHERE a.isfinish='2' and a.route=b.route and a.modid=b.modid and a.route in ".$list." ORDER BY a.id DESC";
...
//		      $arr4[$i]['schedule_date'] = $row4['schedule_date'];
		    ...
		    // 规格下拉筛选数据
		    $sql5 = "SELECT DISTINCT a.product_name FROM productionplan a ,workshop_k b WHERE a.isfinish='1' AND a.modid=b.modid and a.route=b.route and a.route in $list ORDER BY a.id DESC,a.routeid";
		    $res5 = $conn->query($sql5);
		    if($res5->num_rows > 0) {
		      $i = 0;
		      while($row5 = $res5->fetch_assoc()) {
		    ...
		    // 开料尺寸下拉筛选数据
		    $sql6 = "SELECT DISTINCT a.pNumber FROM productionplan a ,workshop_k b WHERE a.isfinish='1' AND a.modid=b.modid and a.route=b.route and a.route in $list ORDER BY a.id DESC,a.routeid";
		    $res6 = $conn->query($sql6);
		    if($res6->num_rows > 0) {
		      $i = 0;
		      while($row6 = $res6->fetch_assoc()) {
		...
		if ($isfinish == '0') {
			...
			// 过滤重复作为下拉checkbox数据
			$sql2 = "SELECT DISTINCT product_name from productionplan WHERE isfinish='0' and isexterior='0' and $searchCondition LIKE '%$searchValue%' ORDER BY id DESC,routeid";
			//DISTINCT通过关键字standard来过滤掉多余的重复记录只保留一条
			$res2 = $conn -> query($sql2);
			if ($res2 -> num_rows > 0) {
				$i = 0;
			...
			$sql3 = "SELECT DISTINCT pNumber from productionplan WHERE isfinish='0' and isexterior='0' and $searchCondition LIKE '%$searchValue%' ORDER BY id DESC,routeid";
			$res3 = $conn -> query($sql3);
			if ($res3 -> num_rows > 0) {
				$i = 0;
				while ($row3 = $res3 -> fetch_assoc()) {
		...
		// 已就工数据列表
	  $sql4 = "select a.modid,a.fid,a.id,a.figure_number,a.name,a.standard,a.route,a.count,a.child_material,a.number,a.product_name,a.remark,b.stime,a.routeid,a.backMark,a.reason,a.pNumber from productionplan a,workshop_k b WHERE a.isfinish='2' and a.modid=b.modid and a.route=b.route and a.`".$searchCondition."` LIKE '%$searchValue%' ORDER BY a.id DESC,a.routeid";
	  $res4 = $conn->query($sql4);
//	  echo $sql4;
	  if($res4->num_rows > 0 ){
	    $i = 0;
...
//	      $arr4[$i]['schedule_date'] = $row4['schedule_date'];
	    ...
	    // 下拉项目名称
	    $sql5 = "SELECT DISTINCT a.product_name FROM productionplan a,workshop_k b WHERE a.isfinish='2' and a.modid=b.modid and a.route=b.route and a.".$searchCondition." LIKE '%$searchValue%' ORDER BY a.id DESC,a.routeid";
	    $res5 = $conn->query($sql5);
	    if($res5->num_rows > 0) {
	      $i = 0;
	      while($row5 = $res5->fetch_assoc()) {
	    ...
	    // 下拉筛选工单
	    $sql6 = "SELECT DISTINCT A.pNumber FROM productionplan a,workshop_k b WHERE a.isfinish='2' and a.modid=b.modid and a.route=b.route and a.".$searchCondition." LIKE '%$searchValue%' ORDER BY a.id DESC,a.routeid";
	    $res6 = $conn->query($sql6);
	    if($res6->num_rows > 0) {
	      $i = 0;
	      while($row6 = $res6->fetch_assoc()) {
...
//		      $arr4[$i]['schedule_date'] = $row4['schedule_date'];
		    ...
		    // 规格下拉筛选数据
		    $sql5 = "SELECT DISTINCT a.product_name FROM productionplan a ,workshop_k b WHERE a.isfinish='1' AND A.modid=B.modid AND a.route=b.route and a.".$searchCondition." LIKE '%$searchValue%' ORDER BY a.id DESC,a.routeid";
		    $res5 = $conn->query($sql5);
		    if($res5->num_rows > 0) {
		      $i = 0;
		      while($row5 = $res5->fetch_assoc()) {
		    ...
		    // 开料尺寸下拉筛选数据
		    $sql6 = "SELECT DISTINCT a.pNumber FROM productionplan a ,workshop_k b WHERE a.isfinish='1' AND A.modid=B.modid AND a.route=b.route and a.".$searchCondition." LIKE '%$searchValue%' ORDER BY a.id DESC,a.routeid";
		    $res6 = $conn->query($sql6);
		    if($res6->num_rows > 0) {
		      $i = 0;
		      while($row6 = $res6->fetch_assoc()) {
			...
			if($searchCondition=='product_name'){
				...
				$sql2 = "SELECT DISTINCT b.name as product_name FROM part a,project b WHERE (a.isexterior='1' or a.isexterior='2' or a.isexterior='3') and (a.fid=b.id) and (b.name LIKE '%$searchValue%') ORDER BY a.id DESC";
				$sql3 = "SELECT DISTINCT a.pNumber FROM part a,project b WHERE (a.isexterior='1' or a.isexterior='2' or a.isexterior='3') and (a.fid=b.id) and (b.name LIKE '%$searchValue%') ORDER BY a.id DESC";
			}else if($searchCondition=='number'){
				$sql = "select a.modid,a.fid,a.id,a.isexterior,a.figure_number,a.name,a.standard,a.count,a.child_material,a.remark,a.isfinish,b.name as product_name,b.number as p_number,a.pNumber from part a,project b WHERE (a.isexterior='1' or a.isexterior='2' or a.isexterior='3') and (a.fid=b.id) and (b.$searchCondition LIKE '%$searchValue%') ORDER BY id DESC";
				$sql2 = "SELECT DISTINCT b.name as product_name FROM part a,project b WHERE (a.isexterior='1' or a.isexterior='2' or a.isexterior='3') and (a.fid=b.id) and (b.$searchCondition LIKE '%$searchValue%') ORDER BY a.id DESC";
				$sql3 = "SELECT DISTINCT a.pNumber FROM part a,project b WHERE (a.isexterior='1' or a.isexterior='2' or a.isexterior='3') and (a.fid=b.id) and (b.$searchCondition LIKE '%$searchValue%') ORDER BY a.id DESC";
			}else{
				$sql = "select a.modid,a.fid,a.id,a.isexterior,a.figure_number,a.name,a.standard,a.count,a.child_material,a.remark,a.isfinish,b.name as product_name,b.number as p_number,a.pNumber from part a,project b WHERE (a.isexterior='1' or a.isexterior='2' or a.isexterior='3') and (a.fid=b.id) and (a.$searchCondition LIKE '%$searchValue%') ORDER BY id DESC";
				$sql2 = "SELECT DISTINCT b.name as product_name FROM part a,project b WHERE (a.isexterior='1' or a.isexterior='2' or a.isexterior='3') and (a.fid=b.id) and (a.$searchCondition LIKE '%$searchValue%') ORDER BY a.id DESC";
				$sql3 = "SELECT DISTINCT a.pNumber FROM part a,project b WHERE (a.isexterior='1' or a.isexterior='2' or a.isexterior='3') and (a.fid=b.id) and (a.$searchCondition LIKE '%$searchValue%') ORDER BY a.id DESC";
			}
